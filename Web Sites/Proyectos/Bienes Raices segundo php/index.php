...
?>
    ...
    <section class="imagen-contacto">
        ...
        <a href="contacto.php" class="boton-amarillo">Contectenos</a>
    </section>
            ...
            <article class="entrada-blog">
                ...
                <div class="texto-entrada">
                    <a href="entrada.php">
                        ...
                        <p>Maximiza el espacio en tu hogar con esta guia, aprende a combinar muebles y colores para darle vida a tu hogar.</p>
                    </a>
                </div>
            </article>
            
        </section>  <!---Acaban las 2 imagenes del blog--->
